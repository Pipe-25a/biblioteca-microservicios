...
public class GlobalExceptionHandler {
    // Maneja cualquier excepción no controlada y devuelve un mensaje de error con estado 400 Bad Request
    ...
    // Maneja IllegalStateException para casos de estado ilegal, devuelve un error con detalles y estado 409 Conflict
    ...
    // Maneja RuntimeException para errores inesperados, devuelve un error con detalles y estado 500 Internal Server Error
